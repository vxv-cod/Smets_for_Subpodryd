...
def startFun(NameProgram, Form, sig, pushButtonList, progressBar, label):
    ...
    def real_decor(my_func):
        def wrapper():
            ...
            color = "0, 153, 76"
            progressBar.setStyleSheet("QProgressBar::chunk {background-color: rgb("f"{color}); margin: 2px;""}")
